...
static ngx_command_t  ngx_http_ssl_commands[] = {
    ...
    { ngx_string("ssl_ttpa"),
      ...
      ngx_conf_set_flag_slot,
      NGX_HTTP_SRV_CONF_OFFSET,
      offsetof(ngx_http_ssl_srv_conf_t, ttpa),
      NULL },
    ...
    { ngx_string("ssl_mb"),
      ...
      ngx_conf_set_flag_slot,
      NGX_HTTP_SRV_CONF_OFFSET,
      offsetof(ngx_http_ssl_srv_conf_t, mb),
      NULL },
...
ngx_http_ssl_create_srv_conf(ngx_conf_t *cf)
{
    ...
    sscf->ttpa = NGX_CONF_UNSET;
    sscf->mb = NGX_CONF_UNSET;
...
ngx_http_ssl_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (!conf->ttpa)
    {
      SSL_CTX_enable_ttpa(conf->ssl.ctx);
    }

    if (!conf->mb)
    {
      SSL_CTX_enable_mb(conf->ssl.ctx);
    }
